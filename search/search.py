    ...
    while not pq.isEmpty():
        ...
        for successor, action, step_cost in problem.getSuccessors(current):
            if successor not in visited:
                pq.push((successor, actions + [action], cost + step_cost),
                cost + step_cost)
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while not pq.isEmpty():
        ...
        for successor, action, step_cost in problem.getSuccessors(current):
            if successor not in visited:
                pq.push((successor, actions + [action], g_cost + step_cost),
                g_cost + step_cost + heuristic(successor, problem))
